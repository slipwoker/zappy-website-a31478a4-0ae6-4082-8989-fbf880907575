    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שיטת איזון אינטגרטיבי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a31478a4-0ae6-4082-8989-fbf880907575',
                    name: data.name || '',
                    email: data.email || '',
